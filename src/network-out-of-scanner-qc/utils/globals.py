...
NBACK_1BACK_MISMATCH_ACC_COMBINED_THRESHOLD_1 = 0.8
NBACK_1BACK_MATCH_ACC_COMBINED_THRESHOLD_2 = 0.55
NBACK_1BACK_MISMATCH_ACC_COMBINED_THRESHOLD_2 = 0.55
NBACK_2BACK_MATCH_ACC_COMBINED_THRESHOLD_1 = 0.2
NBACK_2BACK_MISMATCH_ACC_COMBINED_THRESHOLD_1 = 0.8
NBACK_2BACK_MATCH_ACC_COMBINED_THRESHOLD_2 = 0.55
NBACK_2BACK_MISMATCH_ACC_COMBINED_THRESHOLD_2 = 0.55

# Go_nogo fMRI exclusion thresholds (both conditions must be met)
GONOGO_GO_ACC_THRESHOLD_1 = 0.8
GONOGO_NOGO_ACC_THRESHOLD_1 = 0.2
GONOGO_GO_ACC_THRESHOLD_2 = 0.55
GONOGO_NOGO_ACC_THRESHOLD_2 = 0.55
